...
!!! warning "Important"
    You will only be able to correct the values if the field is set to allow manual changes. For more information, please consult the [`Settings page`](#how-to-release-a-document-step-by-step)
